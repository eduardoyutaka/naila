module Catalyst::SidebarHelper
  ...
  SIDEBAR_ITEM_CLASSES = [
    ...
    "aria-[current=page]:bg-zinc-950/5",
    "dark:text-white dark:*:data-[slot=icon]:fill-zinc-400",
    "dark:aria-[current=page]:bg-white/8",
  ...
  SIDEBAR_DIVIDER_CLASSES = "my-4 border-t border-zinc-950/5 -mx-4 dark:border-white/5".freeze
